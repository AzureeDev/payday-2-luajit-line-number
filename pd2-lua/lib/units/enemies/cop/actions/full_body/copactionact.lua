...
CopActionAct._act_redirects = {
	...
	enemy_spawn = {
		...
		"e_sp_roof_run_repel_into_window",
		"e_sp_down_16m_right",
		"e_sp_down_16m_left",
		"e_sp_down_8m_right",
		"e_sp_down_8m_left",
		...
		"e_sp_fwd_5m_dwn_11m",
		"e_sp_down_5_5m",
		"e_sp_window_down_4_5m",
		"e_sp_fwd_1m_dwn_7_5m",
		"e_sp_down_6m",
		"e_sp_down_6m_var2",
		"e_sp_down_7m",
		"e_sp_down_7m_var2",
	...
	SO = {
		...
		"e_nl_up_0_5_down_4m_swing",
		"e_nl_up_0_5_down_5m_swing",
		"e_nl_up_1_5m_dwn_3_5m",
		"e_nl_up_3_5m_dwn_1_5m",
		...
		"cm_pex_car_enter",
		"cm_pex_door_out",
		"cm_pex_cuffed_sit_exit",
		"cm_pex_cuffed_sit_loop",
		"cm_pex_door_in",
		"cm_pex_stand_loop",
		"cmf_so_slotmachine",
